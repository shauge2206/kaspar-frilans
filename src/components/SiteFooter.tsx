  ...
  return (
    <footer className="bg-deep text-paper mt-24">
      ...
      <div className="border-t border-paper/15">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10 py-6 text-center">
          <p className="font-serif text-lg md:text-xl text-paper">
            Lagd av{" "}
            <a
              href="https://www.naermedia.no/"
              target="_blank"
              rel="noopener noreferrer"
              className="font-semibold text-accent dotted-link hover:brightness-110"
            >
              Nær Media
            </a>
          </p>
